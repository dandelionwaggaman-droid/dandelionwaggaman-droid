...
`Air Permitting` · `LDAR` · `SPCC` · `Stormwater` · `Greenhouse Gas Reporting` · `Waste Management` · `Hazardous Materials` · `Internal Audits` · `Emissions Modeling` · `Regulatory Compliance`

## Tech I Work With

`Python` · `TypeScript` · `Power Automate` · `Supabase` · `Next.js` · `Vercel`

## Geographic Regulatory Knowledge

CO · NM · TX · OK · ND · MT · OR


---

📫 **dandelion@rosethorn.ai**
🌐 **[rosethorn.ai](https://rosethorn.ai)**
💼 **[LinkedIn](https://linkedin.com/in/dandelionwaggaman)**
